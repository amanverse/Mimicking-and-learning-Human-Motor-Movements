...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while True:
        ...
        if results.pose_landmarks:
            ...
            # Write angle values to the text file
            file.write(f"Left Shoulder Angle: {shoulder_angle:.2f}\n")
            file.write(f"Left Elbow Angle: {elbow_angle:.2f}\n")
...
# Release video capture, close window, and close the text file
cap.release()
